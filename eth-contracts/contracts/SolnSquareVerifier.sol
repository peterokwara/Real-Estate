...
contract SolnSquareVerifier is ERC721Token {
    ...
    function submitSolution(
        ...
        require(
            solutions[solutionKey].tokenID == 0,
            "solution has already been used previously; create a new one using ZoKrates"
        );
    ...
    function mint(address to, uint256 tokenID) public returns (bool) {
        ...
        require(
            solutionKey != bytes32(0),
            "no solution submitted for given token ID"
        );
        require(
            !solutions[solutionKey].isMinted,
