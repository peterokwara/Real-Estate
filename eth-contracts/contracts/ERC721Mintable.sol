...
contract Ownable {
    ...
    /**
     * @dev Modifier that requires that the "_owner" account to be the function caller
     */
    modifier onlyOwner() {
    ...
    /**
     * @dev Modifier that requires that an address is valid
     */
...
contract Pausable is Ownable {
    ...
    /**
     * Event for pausing a contract
     */
    event Paused(address account);

    /**
     * Event for unpausing a contract
     */
     ...
     */
    modifier paused() {
        require(_paused, "Contract has not been paused");
        _;
    }

    /**
     * @dev Enable the user to pause a contract
     */
    ...
    /**
     * @dev Enable the user to unpause a contract
     */
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        // Require that the provided address is not the address of the token id
        require(owner != to, "The owner cannont approve his own address");

        // Require that the msg.sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == owner || isApprovedForAll(owner, msg.sender),
            "Message sender needs to be owner of the contract or approved"
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "source address must be the owner of the token"
        );
